# %% markdown
# # Preprocessing ADNI YOUNG
# Preprocess the meshes of ADNI, but only of such subjects that are young enough (less than 70) to possibly observe the effect on
# Young people
# %%
import pandas as pd
import os
