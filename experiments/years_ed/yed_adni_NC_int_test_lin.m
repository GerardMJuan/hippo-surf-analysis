...
model_r = 1 + Age + Gender + Site + Yed + Apoe + Age*Apoe + Agesq*Apoe;
model_l = 1 + Age + Gender + Site + Yed + Apoe + Age*Apoe + Agesq*Apoe;

slm_l = SurfStatLinMod(t_l, model_l, avg_l);
slm_r = SurfStatLinMod(t_r, model_r, avg_r);

% ADDITIVE
model_r_add = 1 + Age + Gender + Site + Yed + Apoe_int + Age*Apoe_int;
model_l_add = 1 + Age + Gender + Site + Yed + Apoe_int + Age*Apoe_int;
...
% ADDITIVE
contrast_list_int_add = {age.*apoe_int, -age.*apoe_int};
save_file_int_add = {'ageNC_HE_HO', 'age-NC_HE_HO'};
...
% List of contrasts
contrast_list = {-age, age, yed, -yed,...% volume_r, -volume_r,...
                 site, -site,...
                 Gender.Male-Gender.Female, Gender.Female-Gender.Male,...
                 Apoe.HE-Apoe.NC, Apoe.NC-Apoe.HE,...
                 Apoe.HO-Apoe.NC, Apoe.NC-Apoe.HO,...
