...
model_r = 1 + Age + Agesq + Gender + Yed + Apoe + Age*Apoe + Agesq*Apoe;
model_l = 1 + Age + Agesq + Gender + Yed + Apoe + Age*Apoe + Agesq*Apoe;

slm_l = SurfStatLinMod(t_l, model_l, avg_l);
slm_r = SurfStatLinMod(t_r, model_r, avg_r);

% ADDITIVE
model_r_add = 1 + Age + Agesq + Gender + Yed + Apoe_int + Age*Apoe_int + Agesq*Apoe_int;
model_l_add = 1 + Age + Agesq + Gender + Yed + Apoe_int + Age*Apoe_int + Agesq*Apoe_int;
...
contrast_list = {-age, age, -agesq, agesq, yed, -yed,...
...
save_file = {'-age', '+age', '-agesq', 'agesq', 'yed', '-yed',...
