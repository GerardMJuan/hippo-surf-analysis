...
model_l = 1 + Age + Agesq + Gender + Site + Volume_l + Apoe + DX + Agesq*Apoe;
model_r = 1 + Age + Agesq + Gender + Site + Volume_r + Apoe + DX + Agesq*Apoe;

slm_l = SurfStatLinMod(t_l, model_l, avg_l);
slm_r = SurfStatLinMod(t_r, model_r, avg_r);

% ADDITIVE
model_r_add = 1 + Age + Agesq + Gender + Site + Volume_r + Apoe_int + DX_int + Agesq*Apoe_int;
model_l_add = 1 + Age + Agesq + Gender + Site + Volume_l + Apoe_int + DX_int + Agesq*Apoe_int;
...
contrast_list_int = {agesq.*Apoe.HE-agesq.*Apoe.NC, agesq.*Apoe.NC-agesq.*Apoe.HE,...
...
% List of files to save
% 
save_file_int = {'agesq+HE_-NC', 'agesq+NC_-HE', 'agesq+HO_-NC', 'agesq+NC_-HO', 'agesq+HO_-HE',...  
             'agesq+HE_-HO', 'agesqHE+NC-HO', 'agesq-HE-NC+HO', 'agesqHE+HO-NC', 'agesq-HE-HO+NC'};

% ADDITIVE
contrast_list_int_add = {agesq.*apoe_int, -agesq.*apoe_int};
save_file_int_add = {'agesqNC_HE_HO', 'agesq-NC_HE_HO'};
