...
model_l = 1 + Age + Gender + Site + Volume_l + Apoe + DX + Age*Apoe;
model_r = 1 + Age + Gender + Site + Volume_r + Apoe + DX + Age*Apoe;

slm_l = SurfStatLinMod(t_l, model_l, avg_l);
slm_r = SurfStatLinMod(t_r, model_r, avg_r);

% ADDITIVE
model_r_add = 1 + Age + Gender + Site + Volume_r + Apoe_int + DX_int + Age*Apoe_int;
model_l_add = 1 + Age + Gender + Site + Volume_l + Apoe_int + DX_int + Age*Apoe_int;
