...
model_l = 1 + Age + Agesq + Gender + Site + Volume_l + DX + Apoe + Age*DX + Agesq*DX;
model_r = 1 + Age + Agesq + Gender + Site + Volume_r + DX + Apoe + Age*DX + Agesq*DX;

slm_l = SurfStatLinMod(t_l, model_l, avg_l);
slm_r = SurfStatLinMod(t_r, model_r, avg_r);

% ADDITIVE
model_r_add = 1 + Age + Agesq + Gender + Site + Volume_r + DX_int + Apoe_int + Age*DX_int + Agesq*DX_int;
model_l_add = 1 + Age + Agesq + Gender + Site + Volume_l + DX_int + Apoe_int + Age*DX_int + Agesq*DX_int;
