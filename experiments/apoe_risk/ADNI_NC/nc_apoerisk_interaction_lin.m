...
model_r = 1 + Age + Gender + Site + Yed + APOE_OR + Age*APOE_OR;
model_l = 1 + Age + Gender + Site + Yed + APOE_OR + Age*APOE_OR;
...
% ADDITIVE
contrast_list_int = {age.*apoe_OR, -age.*apoe_OR};
save_file_int = {'ageapoe_OR', '-ageapoe_OR'};
