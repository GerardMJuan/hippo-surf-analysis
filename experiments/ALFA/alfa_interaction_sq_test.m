...
model_r = 1 + Age + Agesq + Gender + Volume_r + Apoe + Agesq*Apoe;
model_l = 1 + Age + Agesq + Gender + Volume_l + Apoe + Agesq*Apoe;

slm_l = SurfStatLinMod(t_l, model_l, avg_l);
slm_r = SurfStatLinMod(t_r, model_r, avg_r);

% ADDITIVE
model_r_add = 1 + Age + Agesq + Gender + Volume_r + Apoe_int + Agesq*Apoe_int;
model_l_add = 1 + Age + Agesq + Gender + Volume_l + Apoe_int + Agesq*Apoe_int;
